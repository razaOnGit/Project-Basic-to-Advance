...
const Manager = () => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-10 h-full w-full bg-green-200 bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]">
      ...
      <div className="mx-auto container px-40 text-center">
        ...
        <div className="passwords mt-5 mb-5">
            ...
            <>
              ...
              <div className="md:hidden space-y-4">
                {passwordArray.map((item) => (
                  <div
                    key={item.id}
                    className="bg-green-100 rounded-lg p-4 shadow border"
                  >
